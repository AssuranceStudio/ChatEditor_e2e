...
Select "Pixon" vocabulary
    ...
    RPA.desktop.Press Keys    down    right
    RPA.desktop.Press Keys    down
    ${elements}=    RPA.Windows.Get Elements    id:1031
    Log    ${elements}
...
Select vocabulary
    ...
    ...    ${language}=NONE
    ...    ${symbolSet}=NONE
    ...    ${additionalVocabularies}=NONE
    ...    ${downPageButton}=NONE
    ...    ${vocabName}=NONE
    IF    '${language}' != 'NONE'    RPA.Windows.Click    ${language}
    IF    '${symbolSet}' != 'NONE'    RPA.Windows.Click    ${symbolSet}
    IF    '${additionalVocabularies}' != 'NONE'
        RPA.Windows.Click    ${additionalVocabularies}
    END
    IF    '${downPageButton}' != 'NONE'
        RPA.Windows.Click    ${downPageButton}
    END
    IF    '${vocabName}' != 'NONE'    RPA.Windows.Click    ${vocabName}
