...
Assertions for "Talk-About" vocabulary
    ...
    # Check to see if the name of the vocabulary is included in the text box - Talk-About
    RPA.Windows.Click    ${edit_mode_btn}
    ${message}=    RPA.Windows.Get Text    id:65535
    Should Contain    ${message}    The vocabulary "Talk-About"
    RPA.Windows.Click    id:7

    # Check to see if the vocabulary 'name' attribute is its actual name - Talk-About
