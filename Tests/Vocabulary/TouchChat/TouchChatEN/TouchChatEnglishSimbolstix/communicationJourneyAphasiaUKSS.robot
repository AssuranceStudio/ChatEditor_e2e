...
Assertions for "Communication Journey Aphasia UK SS" vocabulary
    ...
    # Check to see if the name of the vocabulary is included in the text box - Communication Journey Aphasia UK SS
    RPA.Windows.Click    ${edit_mode_btn}
    ${message}=    RPA.Windows.Get Text    id:65535
    Should Contain    ${message}    The vocabulary "Communication Journey Aphasia UK SS"
    RPA.Windows.Click    id:7

    # Check to see if the vocabulary 'name' attribute is its actual name - Communication Journey Aphasia UK SS
