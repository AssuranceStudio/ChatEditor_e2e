...
Assertions for "myQuickChat 12 Child PCS" vocabulary
    ...
    # Check to see if the name of the vocabulary is included in the text box - myQuickChat 12 Child PCS
    RPA.Windows.Click    ${edit_mode_btn}
    ${message}=    RPA.Windows.Get Text    id:65535
    Should Contain    ${message}    The vocabulary "myQuickChat 12 Child PCS"
    RPA.Windows.Click    id:7

    # Check to see if the vocabulary 'name' attribute is its actual name - myQuickChat 12 Child PCS
