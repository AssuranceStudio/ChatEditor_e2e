...
Assertions for "WordPower20 Simply SS" vocabulary
    ...
    # Check to see if the name of the vocabulary is included in the text box - WordPower20 Simply SS
    RPA.Windows.Click    ${edit_mode_btn}
    ${message}=    RPA.Windows.Get Text    id:65535
    Should Contain    ${message}    The vocabulary "WordPower20 Simply SS"
    RPA.Windows.Click    id:7

    # Check to see if the vocabulary 'name' attribute is its actual name - WordPower20 Simply SS
